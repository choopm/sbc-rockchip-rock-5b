...
const (
	off int64 = 512 * 64
	// https://gitlab.collabora.com/hardware-enablement/rockchip-3588/u-boot/-/blob/5557bfdc869a2b4f5c5394e6702d32ed5768c7ba/configs/rock5b-rk3588_defconfig#L38
...
func (i *rock5B) Install(options overlay.InstallOptions[rock5BExtraOptions]) error {
	...
	uboot, err := os.ReadFile(filepath.Join(options.ArtifactsPath,
		"arm64/u-boot/rock5b/u-boot-rockchip.bin"))
	if err != nil {
		return err
	}
