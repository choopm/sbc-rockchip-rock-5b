...
const (
	off int64 = 512 * 64
	// https://gitlab.collabora.com/hardware-enablement/rockchip-3588/u-boot/-/blob/5557bfdc869a2b4f5c5394e6702d32ed5768c7ba/configs/rock5a-rk3588s_defconfig#L28
...
func (i *rock5A) Install(options overlay.InstallOptions[rock5AExtraOptions]) error {
	...
	uboot, err := os.ReadFile(filepath.Join(options.ArtifactsPath,
		"arm64/u-boot/rock5a/u-boot-rockchip.bin"))
	if err != nil {
		return err
	}
